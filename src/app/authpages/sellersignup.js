              ...
              <div className='select-seller-type'>
                ...
                <div className='seller-type'>
                  <div className='seller-type-item'>
                    <input type='radio' id='seller-type-1' name='seller-type' />
                  ...
                  <div className='seller-type-item'>
                    <input type='radio' id='seller-type-2' name='seller-type' />
              ...
              <div className='row'>
                ...
                <div className='col-lg-6'>
                  <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                    ...
                    <Form.Control type="text" placeholder="+91 98765 96548" />
                  </Form.Group>
                </div>
                <div className='col-lg-12'>
                  <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                ...
                <div className='col-lg-12 mb-3'>
                  <Link to="/seller/addbusiness">
                    <Button variant="primary" className="w-100">Sign Up</Button>
                  </Link>
                </div>
                <div className='col-lg-12 mb-3'>
                  <p style={{fontSize: "14px"}}>Already have an account? <Link to="/dashboard/superadmin">Log in</Link></p>
                </div>
              </div>
